...
import Rezept from './Rezepte/Teig_lvl1_GebackeneFruechte.json';

const Rezept10_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/teig/level1";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='TeigRezept10_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept10_Three;
