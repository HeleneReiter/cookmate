...
import Rezept from './Rezepte/Gewuerze_lvl3_Gyros.json';

const Rezept15_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept15_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept15_Two;
