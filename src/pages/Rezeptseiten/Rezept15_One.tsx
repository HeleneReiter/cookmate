...
import Rezept from './Rezepte/Gewuerze_lvl3_PalakPaneer.json';

const Rezept15_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept15_One' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept15_One;
