...
import Rezept from './Rezepte/Teig_lvl2_Lahmacun.json';

const Rezept11_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='TeigRezept11_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept11_Two;
