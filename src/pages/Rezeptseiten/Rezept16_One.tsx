...
import Rezept from './Rezepte/Anrichten_lvl1_MangoSmoothieBowl.json';

const Rezept16_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='AnrichtenRezept16_One' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept16_One;