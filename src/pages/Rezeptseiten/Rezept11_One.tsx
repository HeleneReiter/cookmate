...
import Rezept from './Rezepte/Teig_lvl2_Kaesespaetzle.json';

const Rezept11_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='TeigRezept11_One' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept11_One;
