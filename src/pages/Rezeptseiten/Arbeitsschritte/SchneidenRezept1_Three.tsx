...
import Rezept from '../Rezepte/Schneiden_lvl1_AsiaGemuese1.json';
...
const SchneidenRezept1_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/rezept1_Three";
  };
...
export default SchneidenRezept1_Three;
