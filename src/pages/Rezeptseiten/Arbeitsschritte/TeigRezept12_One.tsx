...
import Rezept from '../Rezepte/Teig_lvl3_Marillenknoedel.json';
...
const TeigRezept12_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/rezept12_One";
  };
...
export default TeigRezept12_One;
