...
import Rezept from '../Rezepte/Schneiden_lvl2_VeganeMisosuppe2.json';
...
const SchneidenRezept2_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/rezept2_Three";
  };
...
export default SchneidenRezept2_Three;
