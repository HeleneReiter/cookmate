...
import Rezept from './Rezepte/Backen_lvl1_Vanillekipferl.json';

const Rezept7_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept7_One' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept7_One;
