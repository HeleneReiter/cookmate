...
import Rezept from './Rezepte/Backen_lvl2_Lebkuchen.json';

const Rezept8_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/backen/level2";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept8_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept8_Three;
