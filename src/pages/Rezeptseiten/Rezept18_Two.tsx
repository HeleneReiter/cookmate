...
import Rezept from './Rezepte/Anrichten_lvl3_Ratatouille.json';

const Rezept18_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink="AnrichtenRezept18_Two" className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept18_Two;