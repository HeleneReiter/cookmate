...
import Rezept from './Rezepte/Gewuerze_lvl2_Falafel.json';

const Rezept14_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept14_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept14_Two;
