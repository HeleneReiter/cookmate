...
const BasicRezept_Gewürze: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/basics/Gewurze";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='/BasicGewürzeRezept1' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default BasicRezept_Gewürze;
