...
import Rezept from './Rezepte/Backen_lvl2_Zebrakuchen.json';

const Rezept8_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept8_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept8_Two;
