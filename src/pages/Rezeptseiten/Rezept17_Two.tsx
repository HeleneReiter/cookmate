...
import Rezept from './Rezepte/Anrichten_lvl2_GriechischerHotdog.json';

const Rezept17_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/anrichten/level2";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink="AnrichtenRezept17_Two" className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept17_One;