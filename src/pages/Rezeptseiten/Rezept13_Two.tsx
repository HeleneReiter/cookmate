...
import Rezept from './Rezepte/Gewuerze_lvl1_GriechischerBohnensalat.json';

const Rezept13_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/gewurze/level1";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept13_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept13_Two;
