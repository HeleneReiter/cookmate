...
import Rezept from './Rezepte/Backen_lvl3_ZucchiniKarottenQuiche.json';

const Rezept9_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/backen/level3";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept9_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept9_Three;
