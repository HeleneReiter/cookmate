...
import Rezept from './Rezepte/Backen_lvl1_Vollkornbrot.json';

const Rezept7_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/backen/level1";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept7_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept7_Three;
