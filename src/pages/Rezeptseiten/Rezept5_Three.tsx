...
import Rezept from './Rezepte/saucen_lvl2_Kräutersoße2.json';

const Rezept5_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/marinieren/level2";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton  routerLink='MarinierenRezept5_Three'   className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept5_Three;
