...
import Rezept from './Rezepte/saucen_lvl3_SweetChiliSauce3.json';

const Rezept6_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton  routerLink='MarinierenRezept6_One'  className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept6_One;
