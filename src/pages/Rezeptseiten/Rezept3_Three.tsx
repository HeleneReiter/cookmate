...
import Rezept from './Rezepte/Schneiden_lvl3_GemueseLasagne3.json';

const Rezept3_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='/SchneidenRezept3_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept3_Three;
