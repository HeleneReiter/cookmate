...
import Rezept from './Rezepte/Anrichten_lvl3_SpaghettiEis.json';

const Rezept18_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/anrichten/level3";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink="AnrichtenRezept18_Three" className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept18_Three;