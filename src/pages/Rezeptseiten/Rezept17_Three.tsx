...
import Rezept from './Rezepte/Anrichten_lvl2_Schokoladeneis.json';
...
const Rezept17_One: React.FC = () => {
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink="AnrichtenRezept17_Three" className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
