...
import Rezept from './Rezepte/Teig_lvl1_Topfennockerl.json';

const Rezept10_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='TeigRezept10_One' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept10_One;
