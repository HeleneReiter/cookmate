...
import Rezept from './Rezepte/saucen_lvl2_Bratensoße2.json';

const Rezept4_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/marinieren/level1";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='MarinierenRezept4_Three'  className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept4_Three;
