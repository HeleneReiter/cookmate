...
import Rezept from './Rezepte/Schneiden_lvl1_AvocadoTomatenSalat1.json';
...
const Rezept1_Two: React.FC = () => {
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='SchneidenRezept1_Two'  className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
