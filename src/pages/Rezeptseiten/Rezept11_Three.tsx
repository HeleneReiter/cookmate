...
import Rezept from './Rezepte/Teig_lvl2_Lasagne.json';

const Rezept11_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/teig/level2";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='TeigRezept11_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept11_Three;
