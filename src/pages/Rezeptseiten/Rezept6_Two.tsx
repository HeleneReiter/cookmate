...
import Rezept from './Rezepte/saucen_lvl3_Käsesoße3.json';

const Rezept6_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton  routerLink='MarinierenRezept6_Two'  className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept6_Two;
