...
import Rezept from './Rezepte/Gewuerze_lvl1_Linsensuppe.json';

const Rezept13_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept13_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept13_Three;
