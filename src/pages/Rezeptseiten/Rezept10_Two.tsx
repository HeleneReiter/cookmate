...
import Rezept from './Rezepte/Teig_lvl1_Fladenbrot.json';

const Rezept10_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='TeigRezept10_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept10_Two;
