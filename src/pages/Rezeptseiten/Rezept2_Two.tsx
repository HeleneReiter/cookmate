...
import Rezept from './Rezepte/Schneiden_lvl2_Moussaka2.json';

const Rezept2_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='SchneidenRezept2_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept2_Two;
