...
import Rezept from './Rezepte/Backen_lvl3_LinzerTorte.json';

const Rezept9_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept9_One' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept9_One;
