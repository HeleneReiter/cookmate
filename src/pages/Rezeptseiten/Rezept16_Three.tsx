...
import Rezept from './Rezepte/Anrichten_lvl1_AvocadoMozzarellaSalat.json';

const Rezept16_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/anrichten/level1";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink="AnrichtenRezept16_Three" className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept16_Three;