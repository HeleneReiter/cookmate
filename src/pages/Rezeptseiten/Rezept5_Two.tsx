...
import Rezept from './Rezepte/saucen_lvl2_tomatensauce.json';

const Rezept5_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton  routerLink='MarinierenRezept5_Two'  className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept5_Two;
