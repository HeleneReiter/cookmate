...
import Rezept from './Rezepte/Gewuerze_lvl2_Kartoffelcurry.json';

const Rezept14_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept14_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept14_Three;
