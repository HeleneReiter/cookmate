...
import Rezept from './Rezepte/saucen_lvl2_Knoblauchsauce2.json';

const Rezept5_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='MarinierenRezept5_One'   className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept5_One;
