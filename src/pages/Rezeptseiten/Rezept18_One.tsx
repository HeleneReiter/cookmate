...
import Rezept from './Rezepte/Anrichten_lvl3_GriechischeWraps.json';

const Rezept18_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink="AnrichtenRezept18_One" className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};

export default Rezept18_One;