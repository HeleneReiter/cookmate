...
import Rezept from './Rezepte/saucen_lvl1_joghurtsoße1.json';

const Rezept4_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='MarinierenRezept4_Two'  className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept4_Two;
