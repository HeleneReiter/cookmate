...
import Rezept from './Rezepte/saucen_lvl3_Hollandaise3.json';

const Rezept6_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/marinieren/level3";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton  routerLink='MarinierenRezept6_Three'  className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept6_Three;
