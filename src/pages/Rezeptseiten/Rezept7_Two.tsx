...
import Rezept from './Rezepte/Backen_lvl1_Mamorgugelhupf.json';

const Rezept7_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept7_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept7_Two;
