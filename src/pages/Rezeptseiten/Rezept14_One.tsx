...
import Rezept from './Rezepte/Gewuerze_lvl2_OrientalischeHackbaellchen.json';

const Rezept14_One: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/gewurze/level2";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept14_One' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept14_One;
