...
import Rezept from './Rezepte/Anrichten_lvl2_SalatInGurkenring.json';
...
const Rezept17_One: React.FC = () => {
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink="AnrichtenRezept17_One" className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
