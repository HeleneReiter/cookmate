...
import Rezept from './Rezepte/Gewuerze_lvl3_GriechischerBauernauflauf.json';

const Rezept15_Three: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  const handleCloseClick = () => {
    window.location.href = "/gewurze/level3";
  };
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='GewuerzeRezept15_Three' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept15_Three;
