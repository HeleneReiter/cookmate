...
import Rezept from './Rezepte/Backen_lvl3_Pandamuffins.json';

const Rezept9_Two: React.FC = () => {
  const rezept = {
    name: Rezept.name,
  ...
  >
      <IonContent>
        ...
        <IonButton routerLink='BackenRezept9_Two' className='buttonJetztKochen'> Jetzt Kochen! </IonButton>
      </IonContent>
    </IonPage>
  );
};
export default Rezept9_Two