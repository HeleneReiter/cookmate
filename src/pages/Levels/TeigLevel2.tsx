...
import Rezept from '../Rezeptseiten/Rezepte/Levels/TeigRezepte2.json';

const TeigLevel2 : React.FC = () => {
  ...
  const recipes = ["/Rezept11_One", "/Rezept11_Two", "/Rezept11_Three"]
