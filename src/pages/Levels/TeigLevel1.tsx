...
import Rezept from '../Rezeptseiten/Rezepte/Levels/TeigRezepte1.json';

const TeigLevel1 : React.FC = () => {
  ...
  const recipes = ["/Rezept10_One", "/Rezept10_Two", "/Rezept10_Three"]
