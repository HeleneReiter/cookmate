...
import Rezept from '../Rezeptseiten/Rezepte/Levels/GewuerzeRezepte2.json';

const GewürzeLevel2 : React.FC = () => {
  ...
  const recipes = ["/Rezept14_One", "/Rezept14_Two", "/Rezept14_Three"]
