...
import Rezept from '../Rezeptseiten/Rezepte/Levels/GewuerzeRezepte1.json';

const GewürzeLevel1 : React.FC = () => {
  ...
  const recipes = ["/Rezept13_One", "/Rezept13_Two", "/Rezept13_Three"]
