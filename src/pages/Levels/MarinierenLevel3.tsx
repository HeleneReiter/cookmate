...
import Rezept from '../Rezeptseiten/Rezepte/Levels/MarinierenRezepte3.json';

const MarinierenLevel3 : React.FC = () => {
  ...
  const recipes = ["/Rezept6_One", "/Rezept6_Two", "/Rezept6_Three"]
...
export default MarinierenLevel3;
