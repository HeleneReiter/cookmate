...
import Rezept from '../Rezeptseiten/Rezepte/SchneidenRezepte2.json';
...
const SchneidenLevel2: React.FC = () => {
  ...
  return (
    ...
    >
                ...
                <>
                  ...
                  <IonCard className="custom-ion-card">
                    <div className="box">
                      ...
                      <div className="info"><h2>Schneiden {slide.title}</h2></div>
                    </div>
                  </IonCard>
      ...
      <IonButton className="zumRezept" fill="clear" routerLink="/Rezept2_One" >
        <p>Zum Rezept &gt;</p>
      </IonButton>
