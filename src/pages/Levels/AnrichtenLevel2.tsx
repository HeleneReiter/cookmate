...
import Rezept from '../Rezeptseiten/Rezepte/Levels/AnrichtenRezepte2.json';

const AnrichtenLevel2 : React.FC = () => {
  ...
  const recipes = ["/Rezept17_One", "/Rezept17_Two", "/Rezept17_Three"]
...
export default AnrichtenLevel2;
