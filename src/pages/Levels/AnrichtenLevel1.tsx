...
import Rezept from '../Rezeptseiten/Rezepte/Levels/AnrichtenRezepte1.json';

const AnrichtenLevel1 : React.FC = () => {
  ...
  const recipes = ["/Rezept16_One", "/Rezept16_Two", "/Rezept16_Three"]
...
export default AnrichtenLevel1;
