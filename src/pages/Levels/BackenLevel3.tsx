...
import Rezept from '../Rezeptseiten/Rezepte/Levels/BackenRezepte3.json';

const BackenLevel1 : React.FC = () => {
  ...
  const recipes = ["/Rezept9_One", "/Rezept9_Two", "/Rezept9_Three"]
                ...
                <>
                  ...
                  <IonCard className="custom-ion-card">
                    <div className="box">
                      ...
                      <div className="info"><h2>Backen {slide.title}</h2></div>
                    </div>
                  </IonCard>
